...
const targetAudiences = [
  ...
  { value: "users", label: "Individual Users", icon: User, description: "Select individual users" },
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          {validationErrors.targetAudience && (
            <p className="text-sm text-red-600">{validationErrors.targetAudience}</p>
          )}
        </div>
            ...
            {isEditing ? (
              <>
                ...
                {validationErrors.targetGroups && (
                  <p className="text-sm text-red-600">{validationErrors.targetGroups}</p>
                )}
              </>
            ) : (
            ...
            {isEditing ? (
              <>
                ...
                {validationErrors.targetUsers && (
                  <p className="text-sm text-red-600">{validationErrors.targetUsers}</p>
                )}
              </>
            ) : (
              <div className="space-y-2">
        ...
        {validationErrors.targetSelection && (
          <p className="text-sm text-red-600">{validationErrors.targetSelection}</p>
        )}
        ...
        <div className={`p-3 rounded-lg border ${
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`text-sm font-medium ${
              isTargetingValid() ? "text-green-800" : "text-red-800"
            }`}>
          ...
          {!isTargetingValid() && (
            <p className="text-xs text-red-600 mt-1">
              Please select at least one group or user to target
            </p>
          )}
        </div>
      </CardContent>
